...
const DonationSchema = new Schema({
  ...
  category_id: { type: Schema.Types.ObjectId, ref: 'FoodCategory', required: true },
  category_snapshot: {
    name: String,
    icon_emoji: String,
    color_hex: String,
  ...
  status: {
    type: String,
    enum: ['available', 'partially_claimed', 'fully_claimed', 'completed', 'expired', 'cancelled'],
    default: 'available',
  },
  ...
  pickup_start_time: { type: String, match: [/^\d{2}:\d{2}$/, 'Format HH:mm'] },
