  ...
  return (
    <div className="container py-4">
      <h4 className="fw-bold mb-4">
        <i className="bi bi-chat-dots text-primary me-2"></i>Pesan
      </h4>

      <div className="row g-0 border rounded overflow-hidden" style={{ height: '70vh' }}>
        ...
        <div className="col-md-4 border-end" style={{ overflowY: 'auto' }}>
          {conversations.length === 0 ? (
            ...
            return (
              <div key={conv._id}
                className={`p-3 border-bottom cursor-pointer ${isActive ? 'bg-primary bg-opacity-10' : 'hover-bg-light'}`}
                  ...
                  <div className="flex-grow-1 overflow-hidden">
                    <div className="d-flex justify-content-between">
                      ...
                      {conv.last_message_at && (
                        <small className="text-muted">{formatDate(conv.last_message_at)}</small>
                      )}
                    </div>
                ...
                {active.messages?.length === 0 ? (
                  ...
                  return (
                    <div key={m._id}
                      ...
                      <div className={`px-3 py-2 rounded-3 ${isMe ? 'bg-primary text-white' : 'bg-light text-dark border'}`}
              ...
              <div className="p-3 border-top">
                <form onSubmit={handleSend}>
                  <div className="d-flex gap-2 align-items-end">
                    ...
                    />
                    <button className="btn btn-primary px-3 flex-shrink-0" type="submit">
